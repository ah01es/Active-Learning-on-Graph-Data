...
def supervised_learning(args):
    ...
    train_params_pool = {
        ...
        'Cora': {
            ...
            'transform': None,
            'test_transform': None,
            'loader_tr_args': {'batch_size': train_args.batch_size, 'num_workers': 2},
            'loader_te_args': {'batch_size': train_args.batch_size, 'num_workers': 2},
            'optimizer_args': {'lr': train_args.learning_rate},
            'lr_decay_epochs': train_args.lr_decay_epochs,
            'train_to_end': train_args.train_to_end,
            'log_dir': './logs/Cora',
...
def al_train(args, train_args, train_params, strategy_name):
    X_tr, Y_tr, X_te, Y_te = get_Cora(args.data_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_name', type=str, choices=['MNIST', 'EMNIST', 'Cora',
                                                          'SVHN', 'CIFAR10',
